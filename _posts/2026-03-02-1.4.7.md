...
- [New] Integrated OpenStreetMap and Mapbox Maps, that allows users to seamlessly switch between different map styles and providers, including Google Maps, OpenStreetMap, and Mapbox.
...
- [New] **Home Air the New Home Design**:
  ...
  - **Floating Map Button**: A prominent button at the bottom center allows users to view the properties on map view.
