...
You can **Add** a new section in *Drawer Menu* by following these steps:

- There is a **Add** button at the right-bottom of the screen. Press this *Add* button, a dialog box will open. 
...
- Define the **Widget Type** of the section. There are many widget types as: 
...
- While editing a *default section*, you only get to **Rename** it. You can *Rename* a section just by clicking on **Edit Icon** of respective section. A dialog will open. **Rename** the section as you like. 
...
> Details regarding above opertions can be found in [this](#add-new-section) section.
