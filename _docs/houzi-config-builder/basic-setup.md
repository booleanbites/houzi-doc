...
3. Provide `Wordpress URL` in the required field.   
    ...
    <img src="https://houzi-docs.booleanbites.com/images/add-url-screenshot.png" alt="add-url-screenshot" title="add-url-screenshot" height="500" width = "400" border= "1px solid"/> 
